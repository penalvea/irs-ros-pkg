...
if("FALSE" STREQUAL "TRUE")
  set(omd_SOURCE_PREFIX /home/toni/catkin_ws_indigo/src/omd)
  set(omd_DEVEL_PREFIX /home/toni/catkin_ws_indigo/devel)
  set(omd_INSTALL_PREFIX "")
  set(omd_PREFIX ${omd_DEVEL_PREFIX})
else()
  set(omd_SOURCE_PREFIX "")
  set(omd_DEVEL_PREFIX "")
  set(omd_INSTALL_PREFIX /home/toni/catkin_ws_indigo/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'omd' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'toni <toni@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'omd' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/toni/catkin_ws_indigo/install/${idir}'.  Ask the maintainer 'toni <toni@todo.todo>' to fix it.")
    endif()
    _list_append_unique(omd_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/home/toni/catkin_ws_indigo/src/omd/lib/libOMD.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/toni/catkin_ws_indigo/install/lib;/home/toni/catkin_ws_indigo/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${omd_dep}_FOUND)
      find_package(${omd_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${omd_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND omd_EXPORTED_TARGETS ${${omd_dep}_EXPORTED_TARGETS})
endforeach()
